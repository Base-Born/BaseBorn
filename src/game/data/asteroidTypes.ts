...
export type AsteroidShape = "crag" | "cluster" | "crystal" | "shard" | "crown" | "core";
...
export const ASTEROID_RESPAWN_SECONDS = 300;

export const ASTEROID_SIZES: AsteroidSizeConfig[] = [
  { id: "pebble", label: "Pebble", radiusRange: [14, 18], multiplier: 0.45, miningResistanceMultiplier: 0.75, rewardMultiplier: 0.75 },
  { id: "small", label: "Small", radiusRange: [19, 25], multiplier: 0.75, miningResistanceMultiplier: 0.9, rewardMultiplier: 1 },
  { id: "standard", label: "Standard", radiusRange: [26, 34], multiplier: 1.1, miningResistanceMultiplier: 1, rewardMultiplier: 1.6 },
  { id: "large", label: "Large", radiusRange: [35, 46], multiplier: 2, miningResistanceMultiplier: 1.15, rewardMultiplier: 2.6 },
  { id: "massive", label: "Massive", radiusRange: [47, 60], multiplier: 3.7, miningResistanceMultiplier: 1.35, rewardMultiplier: 4 },
  { id: "giant", label: "Giant", radiusRange: [61, 78], multiplier: 6.5, miningResistanceMultiplier: 1.6, rewardMultiplier: 6 },
  { id: "colossal", label: "Colossal", radiusRange: [79, 100], multiplier: 11, miningResistanceMultiplier: 1.95, rewardMultiplier: 9 },
  { id: "titan", label: "Titan", radiusRange: [101, 128], multiplier: 18, miningResistanceMultiplier: 2.35, rewardMultiplier: 13 },
  { id: "moonlet", label: "Moonlet", radiusRange: [129, 165], multiplier: 30, miningResistanceMultiplier: 2.8, rewardMultiplier: 19 },
  { id: "worldstone", label: "Worldstone", radiusRange: [166, 220], multiplier: 48, miningResistanceMultiplier: 3.25, rewardMultiplier: 28 },
];

export const ASTEROID_QUALITIES: AsteroidQualityConfig[] = [
  { id: "common", label: "Common", etherType: "rawEther", healthMultiplier: 1, xpMultiplier: 1, etherMultiplier: 1, miningResistance: 1, requiredMiningPower: 1, respawnSeconds: ASTEROID_RESPAWN_SECONDS, color: "#747f89", strokeColor: "#c5ced5", glowColor: "rgba(197, 206, 213, .16)", glowStrength: 2, shape: "crag" },
  { id: "uncommon", label: "Uncommon", etherType: "refinedEther", healthMultiplier: 1.8, xpMultiplier: 2.5, etherMultiplier: 2.25, miningResistance: 1.4, requiredMiningPower: 2, respawnSeconds: ASTEROID_RESPAWN_SECONDS, color: "#3d8959", strokeColor: "#8fedaa", glowColor: "rgba(118, 220, 146, .28)", glowStrength: 4, shape: "cluster" },
  { id: "rare", label: "Rare", etherType: "chargedEther", healthMultiplier: 3.2, xpMultiplier: 6, etherMultiplier: 5, miningResistance: 2.1, requiredMiningPower: 4, respawnSeconds: ASTEROID_RESPAWN_SECONDS, color: "#3b6fc2", strokeColor: "#9cc4ff", glowColor: "rgba(104, 167, 255, .3)", glowStrength: 5, shape: "crystal" },
  { id: "epic", label: "Epic", etherType: "radiantEther", healthMultiplier: 6, xpMultiplier: 14, etherMultiplier: 11, miningResistance: 3.5, requiredMiningPower: 7, respawnSeconds: ASTEROID_RESPAWN_SECONDS, color: "#7652bd", strokeColor: "#c9b6ff", glowColor: "rgba(181, 140, 255, .3)", glowStrength: 6, shape: "shard" },
  { id: "legendary", label: "Legendary", etherType: "primalEther", healthMultiplier: 11, xpMultiplier: 35, etherMultiplier: 26, miningResistance: 6, requiredMiningPower: 11, respawnSeconds: ASTEROID_RESPAWN_SECONDS, color: "#bd8e20", strokeColor: "#ffe18a", glowColor: "rgba(255, 209, 102, .32)", glowStrength: 7, shape: "crown" },
  { id: "unique", label: "Core", etherType: "coreEther", healthMultiplier: 22, xpMultiplier: 90, etherMultiplier: 65, miningResistance: 10, requiredMiningPower: 16, respawnSeconds: ASTEROID_RESPAWN_SECONDS, color: "#bd512d", strokeColor: "#ffb083", glowColor: "rgba(255, 147, 92, .34)", glowStrength: 8, shape: "core" },
];
...
export function getAsteroidComputedValues(sizeTier: AsteroidSizeTier, quality: AsteroidQuality) {
  ...
  return {
    ...
    respawnSeconds: ASTEROID_RESPAWN_SECONDS,
  };
}
