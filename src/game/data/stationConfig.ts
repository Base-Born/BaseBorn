...
export const STATION_CONFIG = {
  ...
  stationPilotAcceleration: 610,
  stationPilotActiveDamping: 0.42,
  stationPilotIdleDamping: 0.16,
  stationNetworkCorrection: 0.16,
  stationFacingResponse: 10,
  stationTurretResponse: 18,
  spacecraftTurretMountX: 0.765,
  spacecraftTurretMountY: -0.186,
  spacecraftTurretBarrelLength: 82,
