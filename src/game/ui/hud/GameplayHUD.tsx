...
export function GameplayHUD({ snapshot, onOpenCargo, onOpenCommand, onOpenShip, onOpenGuide, onToggleAutoFire, onToggleAutoThrottle }: { snapshot: GameSnapshot; onOpenCargo: () => void; onOpenCommand: () => void; onOpenShip: () => void; onOpenGuide: () => void; onToggleAutoFire: () => void; onToggleAutoThrottle: () => void }) {
